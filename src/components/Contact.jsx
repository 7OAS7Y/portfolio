...
const Contact = () => {
  return (
    <Stack>
      <Box sx={{ m: 8, maxWidth: 800, border: '2px solid #324673', borderRadius: 3, boxShadow: '0px 10px 25px 0px #324673e0' }}>
        <Box sx={{ m: 10, }}>
          <h1>Contact</h1>
        </Box>
        <Link href='https://www.linkedin.com/in/joshua-crothers-3592ba1b5/' target='_blank' rel="noopener" underline="none">
          <Box sx={{ m: 2, maxWidth: 500, border: '2px solid #324673', borderRadius: 3, boxShadow: '0px 10px 25px 0px #324673e0' }}>
